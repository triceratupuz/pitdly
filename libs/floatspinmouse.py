...
'''
Subclassing of
http://wxpython.org/Phoenix/docs/html/lib.agw.floatspin.html
to add mouse movement control

NOTE:
Needs at least explicit declaration of folloving wx.lib.agw.floatspin.FloatSpin arguments 
...
class FloatSpinMouse(wx.lib.agw.floatspin.FloatSpin):
    def __init__(self, *args, **kwargs):
        ...
        '''
        super(FloatSpinMouse, self).__init__(*args, **kwargs)
...
class FloatSpinMouseTs(FloatSpinMouse):
    '''transmit value to a csound table'''
    def __init__(self, *args, **kwargs):
        self.cSound = kwargs.pop('cSound', None)
        self.indxN = kwargs.pop('indxn', None)
        self.tabN = kwargs.pop('ftable', None)
        super(FloatSpinMouseTs, self).__init__(*args, **kwargs)#super the subclass
...
if __name__ == '__main__':
    class MyFrame(wx.Frame):
        def __init__(self, parent, id):
            ...
            input = FloatSpinMouse(parent=panel, id=-1,digits= 3,min_val=0.0, max_val= 2.103, increment= 0.05,increment_m= 0.001)
            input.SetValue(0.66)
